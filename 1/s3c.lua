...
lib:btn("Goose quote", "http://www.roblox.com/asset/?id=9057867582", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/specowos/3-cool-scripts-repo/main/(3cs)%20part%202/Goose%20Quotes.lua"))()
end)

lib:btn("R6 Legless", "http://www.roblox.com/asset/?id=9057868443", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/specowos/3-cool-scripts-repo/main/(3cs)%20part%202/R6%20Legless.lua"))()
end)

lib:btn("BHop", "http://www.roblox.com/asset/?id=9057869695", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/specowos/3-cool-scripts-repo/main/(3cs)%20part%202/BHOP.lua"))()
end)